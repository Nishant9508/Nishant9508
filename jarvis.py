...
def sendmail(to,content):
    ...
    server.ehlo()
    server.starttls()
    server.login("j13mohit@gmail.com","Mohit@7325")
    server.sendmail("j13mohit@gmail.com", to, content)
    server.close()


def screenshot():
    img = pyautogui.screenshot()
    img.save("C:/Users/Mohit/Pictures/Screenshots/pythonss.png")
